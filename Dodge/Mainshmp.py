...
#load images
alien_img = pygame.image.load("spaceShip.png").convert_alpha()
...
pygame.image.load("shipGreen.png").convert_alpha()
player_Img = pygame.image.load("shipGreen.png").convert_alpha()
